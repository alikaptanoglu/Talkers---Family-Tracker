...
String printDuration(Duration duration) {
  ...
  return duration.inHours !=  0 ? "${twoDigits(duration.inHours, 'h')} $twoDigitMinutes $twoDigitSeconds" : duration.inMinutes != 0 ? "$twoDigitMinutes $twoDigitSeconds" : twoDigitSeconds;
}
